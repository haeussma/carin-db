...
class SheetModel(BaseModel):
    ...
    def add_to_sheets(
        ...
        **kwargs,
        ...
        self.sheets.append(Sheet(**params))
    ...
    def add_to_sheet_connections(
        ...
        **kwargs,
        ...
        self.sheet_connections.append(SheetConnection(**params))
    ...
    def add_to_sheet_references(
        ...
        **kwargs,
        ...
        self.sheet_references.append(SheetReferences(**params))
...
class Sheet(BaseModel):
    ...
    # JSON-LD fields
    ld_id: str = Field(
        serialization_alias="@id", default_factory=lambda: "md:Sheet/" + str(uuid4())
    )
    ld_type: list[str] = Field(
        serialization_alias="@type",
        default_factory=lambda: [
    ...
    def add_to_columns(
        ...
        **kwargs,
        ...
        params = {"name": name, "data_type": data_type}
...
class Column(BaseModel):
    ...
    # JSON-LD fields
    ld_id: str = Field(
        serialization_alias="@id", default_factory=lambda: "md:Column/" + str(uuid4())
    )
    ld_type: list[str] = Field(
        serialization_alias="@type",
        default_factory=lambda: [
...
class GraphModel(BaseModel):
    ...
    def add_to_nodes(
        ...
        **kwargs,
        ...
        params = {"name": name, "attributes": attributes}
    ...
    def add_to_relationships(
        ...
        **kwargs,
        ...
        params = {"source": source, "name": name, "targets": targets}

        if "id" in kwargs:
            params["id"] = kwargs["id"]

        self.relationships.append(Relationship(**params))
...
class Node(BaseModel):
    ...
    # JSON-LD fields
    ld_id: str = Field(
        serialization_alias="@id", default_factory=lambda: "md:Node/" + str(uuid4())
    )
    ld_type: list[str] = Field(
        serialization_alias="@type",
        default_factory=lambda: [
    ...
    def add_to_attributes(
        ...
        **kwargs,
        ...
        self.attributes.append(Attribute(**params))
